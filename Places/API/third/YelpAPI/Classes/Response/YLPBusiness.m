...
- (instancetype)initWithDictionary:(NSDictionary *)businessDict {
    if (self = [super init]) {
        NSLog(@"%s - %@", __PRETTY_FUNCTION__, businessDict);
        ...
        _price = [businessDict objectForKey:@"price"];
        
        _transactions = [[businessDict objectForKey:@"transactions"] componentsJoinedByString:@","];
